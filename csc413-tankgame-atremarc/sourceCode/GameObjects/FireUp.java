...
//The FireUp class handles the creation of the "F" tiles. The "F" tile is a power up that when touched by the player
//will disappear granting the player a firing rate of twice as fast as previously.
public class FireUp extends Tiles {

    private int xPos;                   //x coordinate of the tile
    private int yPos;                   //y coordinate of the tile
    private final int RANK = 5;         //rank of the tile (used to ID the tile "type" outside this class
    ...
    public FireUp () {
        ...
        try {
            this.img = read(new File("fireRate.png"));
