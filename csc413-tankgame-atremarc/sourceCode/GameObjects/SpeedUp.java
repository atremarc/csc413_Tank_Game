...
//The SpeedUp class handles the creation of the "S" tiles. The "S" tile is a power up that when touched by the player
//will disappear granting the player an additional speed boost.
public class SpeedUp extends Tiles {

    private int xPos;                   //x coordinate of the tile
    private int yPos;                   //y coordinate of the tile
    private final int RANK = 4;         //rank of the tile (used to ID the tile "type" outside this class
    ...
    public SpeedUp () {
        ...
        try {
            this.img = read(new File("speed.png"));
