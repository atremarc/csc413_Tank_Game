...
//The BreakWall class handles the creation of breakable wall tiles in the game. These tiles are destroyed if hit with a
//bullet from the Tanks.
public class BreakWall extends Tiles{

    private int xPos;                   //x coordinate of the tile
    private int yPos;                   //y coordinate of the tile
    private final int RANK = 2;         //rank of the tile (used to ID the tile "type" outside this class
    ...
    public BreakWall () {
        ...
        try {
            this.img = read(new File("break.png"));
